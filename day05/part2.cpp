...
int main() {
    ...
    while(getline(input, line)) {
        ...
        if(!read_crates) {
            ...
            // Move the crates.
            // We use a buffer because that's an easy way to retain order when moving crates around,
            // though this solution doesn't necessarily scale well.
            // TODO: move the crates without the buffer.
